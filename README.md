...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5fzujem.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5fzujem.containers.anotherwebservice.com/
...
```
git clone git@github.com:freza1/container-5fzujem.git
cd container-5fzujem
```
...
```
docker attach container-5fzujem
```
